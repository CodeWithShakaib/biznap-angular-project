!(function (e, t) {
  ...
  r.default(document).on('click.bs.alert.data-api', '[data-dismiss="alert"]', d._handleDismiss(new d())),
  ...
  r
    ...
    .on('click.bs.button.data-api', '[data-toggle^="button"]', function (e) {
      var t = e.target,
        n = t;
      if (
        (r.default(t).hasClass('btn') || (t = r.default(t).closest('.btn')[0]),
        ...
        ('INPUT' !== n.tagName && 'LABEL' === t.tagName) ||
          p._jQueryInterface.call(r.default(t), 'toggle', 'INPUT' === n.tagName);
      }
    })
      ...
      return (
        ...
        (t._addTouchEventListeners = function () {
          ...
          if (this._touchSupported) {
            var t = function (t) {
                e._pointerEvent && _[t.originalEvent.pointerType.toUpperCase()]
        ...
        (t._slide = function (e, t) {
          ...
          if (
            ...
            var h = r.default.Event('slid.bs.carousel', { relatedTarget: c, direction: o, from: l, to: f });
            if (r.default(this._element).hasClass('slide')) {
              r.default(c).addClass(i), u.reflow(c), r.default(s).addClass(n), r.default(c).addClass(n);
  ...
  r.default(document).on('click.bs.carousel.data-api', '[data-slide], [data-slide-to]', b._dataApiClickHandler),
    ...
    (r.default.fn[g] = b._jQueryInterface),
    (r.default.fn[g].Constructor = b),
    (r.default.fn[g].noConflict = function () {
      return (r.default.fn[g] = m), b._jQueryInterface;
    });
  var w = 'collapse',
    T = r.default.fn[w],
    E = { toggle: !0, parent: '' },
    ...
    C = (function () {
      function e(e, t) {
        ...
        for (
          var n = [].slice.call(document.querySelectorAll('[data-toggle="collapse"]')), i = 0, r = n.length;
          i < r;
          i++
        ) {
          var o = n[i],
      ...
      return (
            ...
            if ((r.default(this._element).trigger(t), !t.isDefaultPrevented())) {
              ...
              if (i > 0)
                for (var o = 0; o < i; o++) {
                  ...
                  null !== s &&
                    (r.default([].slice.call(document.querySelectorAll(s))).hasClass('show') ||
                      r.default(a).addClass('collapsed').attr('aria-expanded', !1));
                }
              ...
              r.default(this._element)
                .one(u.TRANSITION_END, function () {
                  e.setTransitioning(!1),
                    r.default(e._element).removeClass('collapsing').addClass('collapse').trigger('hidden.bs.collapse');
                })
                .emulateTransitionEnd(l);
            }
          }
        ...
        (t._getConfig = function (e) {
          return ((e = l({}, E, e)).toggle = Boolean(e.toggle)), u.typeCheckConfig(w, e, x), e;
        }),
        ...
        (t._getParent = function () {
          ...
          var i = [].slice.call(
            t.querySelectorAll('[data-toggle="collapse"][data-parent="' + this._config.parent + '"]')
          );
          return (
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              (!i && o.toggle && 'string' == typeof t && /show|hide/.test(t) && (o.toggle = !1),
  ...
  var S = 'dropdown',
    ...
    j = (function () {
      ...
      return (
          ...
          if (
            ...
            if ((r.default(a).trigger(i), !i.isDefaultPrevented())) {
              ...
              'ontouchstart' in document.documentElement &&
                ...
                r.default(document.body).children().on('mouseover', null, r.default.noop),
                this._element.focus(),
                this._element.setAttribute('aria-expanded', !0),
                r.default(this._menu).toggleClass('show'),
                r.default(a).toggleClass('show').trigger(r.default.Event('shown.bs.dropdown', n));
            }
          }
        }),
        (t.hide = function () {
          if (
            ...
            r.default(i).trigger(n),
              n.isDefaultPrevented() ||
                ...
                r.default(this._menu).toggleClass('show'),
                r.default(i).toggleClass('show').trigger(r.default.Event('hidden.bs.dropdown', t)));
          }
        }),
        (t.dispose = function () {
        ...
        (t._getConfig = function (e) {
          return (
            (e = l({}, this.constructor.Default, r.default(this._element).data(), e)),
        ...
        (t._getPlacement = function () {
          ...
          return (
            e.hasClass('dropup')
              ? (t = r.default(this._menu).hasClass('dropdown-menu-right') ? 'top-end' : 'top-start')
              : e.hasClass('dropright')
              ? (t = 'right-start')
              : e.hasClass('dropleft')
              ? (t = 'left-start')
              : r.default(this._menu).hasClass('dropdown-menu-right') && (t = 'bottom-end'),
            t
          );
        }),
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              (n || ((n = new e(this, 'object' == typeof t ? t : null)), r.default(this).data('bs.dropdown', n)),
              'string' == typeof t)
            ) {
        ...
        (e._clearMenus = function (t) {
          if (!t || (3 !== t.which && ('keyup' !== t.type || 9 === t.which)))
            for (
              var n = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), i = 0, o = n.length;
              i < o;
              i++
            ) {
                ...
                if (
                  ...
                  r.default(a).trigger(c),
                    c.isDefaultPrevented() ||
                      ('ontouchstart' in document.documentElement &&
                        r.default(document.body).children().off('mouseover', null, r.default.noop),
                      n[i].setAttribute('aria-expanded', 'false'),
                      s._popper && s._popper.destroy(),
                      r.default(u).removeClass('show'),
                      r.default(a).removeClass('show').trigger(r.default.Event('hidden.bs.dropdown', l)));
                }
              }
            }
        }),
        ...
        (e._dataApiKeydownHandler = function (t) {
          if (
            !(/input|textarea/i.test(t.target.tagName)
              ? 32 === t.which ||
                (27 !== t.which &&
                  ((40 !== t.which && 38 !== t.which) || r.default(t.target).closest('.dropdown-menu').length))
              : !A.test(t.which)) &&
            !this.disabled &&
            ...
            if (i || 27 !== t.which) {
              if ((t.preventDefault(), t.stopPropagation(), !i || 27 === t.which || 32 === t.which))
                return (
                  27 === t.which && r.default(n.querySelector('[data-toggle="dropdown"]')).trigger('focus'),
  ...
  r
    ...
    .on('click.bs.dropdown.data-api', '[data-toggle="dropdown"]', function (e) {
      e.preventDefault(), e.stopPropagation(), j._jQueryInterface.call(r.default(this), 'toggle');
    })
      ...
      return (
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            r.default(this._element).trigger(n),
              this._isShown ||
                ...
                r.default(this._element).on('click.dismiss.bs.modal', '[data-dismiss="modal"]', function (e) {
                  return t.hide(e);
                }),
        ...
        (t._triggerBackdropTransition = function () {
          ...
          if ('static' === this._config.backdrop) {
            ...
            if ((r.default(this._element).trigger(t), t.isDefaultPrevented())) return;
        ...
        (t._showElement = function (e) {
          ...
          if (n) {
            ...
            r.default(this._dialog).one(u.TRANSITION_END, a).emulateTransitionEnd(s);
          } else a();
        }),
        ...
        (t._setEscapeEvent = function () {
          var e = this;
          this._isShown
            ? r.default(this._element).on('keydown.dismiss.bs.modal', function (t) {
        ...
        (t._showBackdrop = function (e) {
          ...
          if (this._isShown && this._config.backdrop) {
            if (
              ...
              r.default(this._element).on('click.dismiss.bs.modal', function (e) {
            ...
            if (r.default(this._element).hasClass('fade')) {
              ...
              r.default(this._backdrop).one(u.TRANSITION_END, o).emulateTransitionEnd(a);
            } else o();
          } else e && e();
        }),
        ...
        (e._jQueryInterface = function (t, n) {
          return this.each(function () {
            var i = r.default(this).data('bs.modal'),
              o = l({}, L, r.default(this).data(), 'object' == typeof t && t ? t : {});
  ...
  r.default(document).on('click.bs.modal.data-api', '[data-toggle="modal"]', function (e) {
    ...
    (r.default.fn.modal.noConflict = function () {
      return (r.default.fn.modal = I), q._jQueryInterface;
    });
    ...
    V = (function () {
      ...
      return (
        ...
        (t.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            r.default(a).data(this.constructor.DATA_KEY, this),
              r.default.contains(this.element.ownerDocument.documentElement, this.tip) || r.default(a).appendTo(f),
              r.default(this.element).trigger(this.constructor.Event.INSERTED),
              (this._popper = new o.default(this.element, a, this._getPopperConfig(c))),
        ...
        (t.setContent = function () {
          ...
          this.setElementContent(r.default(e.querySelectorAll('.tooltip-inner')), this.getTitle()),
            r.default(e).removeClass('fade show');
        }),
        (t.setElementContent = function (e, t) {
          'object' != typeof t || (!t.nodeType && !t.jquery)
            ? this.config.html
              ? (this.config.sanitize && (t = F(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t))
              : e.text(t)
            : this.config.html
        ...
        (t._enter = function (e, t) {
          ...
          (t = t || r.default(e.currentTarget).data(n)) ||
            ...
            r.default(t.getTipElement()).hasClass('show') || 'show' === t._hoverState
              ? (t._hoverState = 'show')
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (i || ((i = new e(this, o)), n.data('bs.tooltip', i)), 'string' == typeof t)
            ) {
              if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
              i[t]();
            }
  ...
  (r.default.fn[M] = V._jQueryInterface),
    (r.default.fn[M].Constructor = V),
    (r.default.fn[M].noConflict = function () {
      return (r.default.fn[M] = B), V._jQueryInterface;
    });
  var Y = 'popover',
    K = r.default.fn[Y],
        ...
        (i._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              ...
              (t || ((t = new i(this, n)), r.default(this).data('bs.popover', t)), 'string' == typeof e)
            ) {
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              (n || ((n = new e(this, 'object' == typeof t && t)), r.default(this).data('bs.scrollspy', n)),
              'string' == typeof t)
            ) {
              if (void 0 === n[t]) throw new TypeError('No method named "' + t + '"');
              n[t]();
      ...
      return (
        ...
        (t._activate = function (e, t, n) {
          ...
          if (o && a) {
            ...
            r.default(o).removeClass('show').one(u.TRANSITION_END, s).emulateTransitionEnd(l);
          } else s();
        }),
  ...
  var ue = r.default.fn.toast,
    ...
    de = (function () {
      ...
      return (
        ...
        (t._getConfig = function (e) {
          return (
            (e = l({}, fe, r.default(this._element).data(), 'object' == typeof e && e ? e : {})),
  ...
  (function (e, t) {
      ...
      w.extend({
        ...
        isPlainObject: function (e) {
          ...
          return !(
            ...
            ((t = i(e)) && ('function' != typeof (n = c.call(t, 'constructor') && t.constructor) || f.call(n) !== d))
          );
        },
        ...
        map: function (e, t, n) {
          var i,
            ...
            a = 0,
            s = [];
          if (T(e)) for (i = e.length; a < i; a++) null != (r = t(e[a], a, n)) && s.push(r);
                    ...
                    if (((p = [a ? m.firstChild : m.lastChild]), a && y)) {
                      for (
                        _ =
                          (h =
                            (u =
                              (c = (f = (d = m)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] ===
                              T && u[1]) && u[2],
                          d = h && m.childNodes[h];
                      ...
                      (y &&
                        (_ = h =
                          (u =
                            (c = (f = (d = t)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] ===
                            T && u[1]),
                      !1 === _)
                    )
                      for (
                        ...
                        ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) ||
                          !++_ ||
                          (y && ((c = (f = d[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [T, _]),
                          d !== t));
        ...
        return (
          ...
          ue(function (o, a, s, l) {
            var u,
              ...
              v = n ? (r || (o ? e : p || i) ? [] : a) : m;
            if ((n && n(m, v, s, l), i))
              for (u = Te(v, h), i(u, [], s, l), c = u.length; c--; ) (f = u[c]) && (v[h[c]] = !(m[h[c]] = f));
            if (o) {
              if (r || e) {
                if (r) {
            ...
            } else (v = Te(v === a ? v.splice(p, v.length) : v)), r ? r(null, a, v, l) : L.apply(a, v);
          })
        );
      }
      function xe(e) {
        for (
          ...
          if ((n = i.relative[e[l].type])) d = [be(we(d), n)];
            ...
            if ((n = i.filter[e[l].type].apply(null, e[l].matches))[b]) {
              ...
              return Ee(
                1 < l && we(d),
                1 < l && _e(e.slice(0, l - 1).concat({ value: ' ' === e[l - 2].type ? '*' : '' })).replace(W, '$1'),
                n,
                l < r && xe(e.slice(l, r)),
                r < o && xe((e = e.slice(r))),
                r < o && _e(e)
      ...
      return (
        ...
        (s = se.compile = function (e, t) {
          var n,
            ...
            m = S[e + ' '];
          if (!m) {
            for (t || (t = a(e)), n = t.length; n--; ) (m = xe(t[n]))[b] ? f.push(m) : p.push(m);
            (m = S(
              e,
              ((r = p),
              (s = 0 < (o = f).length),
              ...
              (c = function (e, t, n, a, c) {
                var f,
                  ...
                  C = E.length;
                for (c && (u = t == h || t || c); y !== C && null != (f = E[y]); y++) {
                  if (l && f) {
                  ...
                  s && ((f = !m && f) && v--, e && _.push(f));
                }
                if (((v += y), s && y !== v)) {
                  for (p = 0; (m = o[p++]); ) m(_, b, t, n);
                  if (e) {
                    if (0 < v) for (; y--; ) _[y] || b[y] || (b[y] = j.call(a));
                    b = Te(b);
                  }
                  L.apply(a, b), c && !e && 0 < b.length && 1 < v + o.length && se.uniqueSort(a);
                }
                return c && ((T = x), (u = w)), _;
              }),
              s ? ue(c) : c)
      ...
      if (((n = n || N), 'string' == typeof e)) {
        ...
        if (i[1]) {
          if (
            (w.merge(
              this,
              w.parseHTML(i[1], (t = t instanceof w ? t[0] : t) && t.nodeType ? t.ownerDocument || t : m, !0)
            ),
        ...
        function (e, t) {
          w.fn[e] = function (n, i) {
            ...
            return (
              ...
              1 < this.length && (L[e] || w.uniqueSort(r), I.test(e) && r.reverse()),
              this.pushStack(r)
            );
          };
        }
    ...
    (w.Callbacks = function (e) {
              ...
              a &&
                ...
                (function t(n) {
                  w.each(n, function (n, i) {
                    p(i) ? (e.unique && c.has(i)) || a.push(i) : i && i.length && 'string' !== _(i) && t(i);
                  });
                })(arguments),
                i && !n && u()),
              this
      ...
      w.extend({
                      ...
                      u = function () {
                        ...
                        if (!(t < o)) {
                          ...
                          p((u = e && ('object' == typeof e || 'function' == typeof e) && e.then))
                            ? r
                              ? u.call(e, a(o, n, P, r), a(o, n, R, r))
                              : (o++, u.call(e, a(o, n, P, r), a(o, n, R, r), a(o, n, P, n.notifyWith)))
                        ...
                        : function () {
                            try {
                              ...
                              w.Deferred.exceptionHook && w.Deferred.exceptionHook(u, c.stackTrace),
                                o <= t + 1 && (i !== R && ((s = void 0), (l = [u])), n.rejectWith(s, l));
                            }
                          };
        ...
        when: function (e) {
          ...
          if (t <= 1 && (H(e, a.done(s(n)).resolve, a.reject, !t), 'pending' === a.state() || p(o[n] && o[n].then)))
            return a.then();
    ...
    (w.fn.ready = function (e) {
      ...
      'complete' === m.readyState || ('loading' !== m.readyState && !m.documentElement.doScroll)
        ...
        : (m.addEventListener('DOMContentLoaded', B), e.addEventListener('load', B));
    var W = function (e, t, n, i, r, o, a) {
        var s = 0,
          l = e.length,
          u = null == n;
        if ('object' === _(n)) for (s in ((r = !0), n)) W(e, t, s, n[s], !0, o, a);
        else if (
          void 0 !== i &&
          ((r = !0),
          p(i) || (a = !0),
        ...
        data: function (e, t) {
          ...
          if (void 0 === e) {
            if (this.length && ((r = K.get(o)), 1 === o.nodeType && !Y.get(o, 'hasDataAttrs'))) {
              for (n = a.length; n--; )
                a[n] && 0 === (i = a[n].name).indexOf('data-') && ((i = z(i.slice(5))), Z(o, i, r[i]));
      ...
      w.fn.extend({
        ...
        promise: function (e, t) {
          ...
          for ('string' != typeof e && ((t = e), (e = void 0)), e = e || 'fx'; a--; )
            (n = Y.get(o[a], e + 'queueHooks')) && n.empty && (i++, n.empty.add(s));
    ...
    var ae = function (e, t) {
      return (
        'none' === (e = t || e).style.display || ('' === e.style.display && re(e) && 'none' === w.css(e, 'display'))
      );
    };
    function se(e, t, n, i) {
      var r,
      ...
      if (c && c[3] !== u) {
        for (u = u || c[3], c = +(l /= 2) || 1; a--; )
          w.style(e, t, c + u), (1 - o) * (1 - (o = s() / l || 0.5)) <= 0 && (a = 0), (c /= o);
          ...
          if ('object' === _(o)) w.merge(d, o.nodeType ? [o] : o);
            ...
            for (
              a = a || f.appendChild(t.createElement('div')),
                ...
                a.innerHTML = (l = ge[s] || ge._default)[1] + w.htmlPrefilter(o) + l[2],
                c = l[0];
              c--;
          ...
          w.event.add(e, t, {
            ...
            handler: function (e) {
              ...
              if (1 & e.isTrigger && this[t]) {
                ...
                a.length &&
                  (Y.set(this, t, { value: w.event.trigger(w.extend(a[0], w.Event.prototype), a.slice(1), this) }),
        ...
        if (X(e))
          for (
            ...
            (h = g = (s = Te.exec(t[u]) || [])[1]),
              ...
              h &&
                ((f = w.event.special[h] || {}),
                (f = w.event.special[(h = (r ? f.delegateType : f.bindType) || h)] || {}),
                (c = w.extend(
                  {
                    type: h,
                    origType: g,
        ...
        if (m && (l = m.events)) {
          for (u = (t = (t || '').match(q) || ['']).length; u--; )
            if (((h = g = (s = Te.exec(t[u]) || [])[1]), (p = (s[2] || '').split('.').sort()), h)) {
              ...
              a &&
                !d.length &&
                ((f.teardown && !1 !== f.teardown.call(e, p, m.handle)) || w.removeEvent(e, h, m.handle), delete l[h]);
          ...
          for (a = w.event.handlers.call(this, l, u), t = 0; (r = a[t++]) && !l.isPropagationStopped(); )
            for (l.currentTarget = r.elem, n = 0; (o = r.handlers[n++]) && !l.isImmediatePropagationStopped(); )
              (l.rnamespace && !1 !== o.namespace && !l.rnamespace.test(o.namespace)) ||
                ((l.handleObj = o),
                (l.data = o.data),
                void 0 !== (i = ((w.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, s)) &&
                  !1 === (l.result = i) &&
    ...
    function qe(e, t, n, i) {
      ...
      if (
        d &&
        ((a = (r = _e(t, e[0].ownerDocument, !1, e, i)).firstChild), 1 === r.childNodes.length && (r = a), a || i)
      ) {
        for (l = (s = w.map(me(r, 'script'), Ie)).length; f < d; f++)
          (u = r), f !== g && ((u = w.clone(u, !0, !0)), l && w.merge(s, me(u, 'script'))), n.call(e[f], u, f);
        if (l)
          for (c = s[s.length - 1].ownerDocument, w.map(s, Le), f = 0; f < l; f++)
            pe.test((u = s[f]).type || '') &&
              ...
              (u.src && 'module' !== (u.type || '').toLowerCase()
                ? w._evalUrl && !u.noModule && w._evalUrl(u.src, { nonce: u.nonce || u.getAttribute('nonce') }, c)
      ...
      clone: function (e, t, n) {
        ...
        if (!(h.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || w.isXMLDoc(e)))
          for (a = me(c), i = 0, r = (o = me(e)).length; i < r; i++)
            (s = o[i]),
              'input' === (u = (l = a[i]).nodeName.toLowerCase()) && de.test(s.type)
                ? (l.checked = s.checked)
                : ('input' !== u && 'textarea' !== u) || (l.defaultValue = s.defaultValue);
        if (t)
          if (n) for (o = o || me(e), a = a || me(c), i = 0, r = o.length; i < r; i++) Oe(o[i], a[i]);
          else Oe(e, c);
        ...
        'margin' === n && (l += w.css(e, n + ne[a], !0, r)),
          i
            ? ('content' === n && (l -= w.css(e, 'padding' + ne[a], !0, r)),
              'margin' !== n && (l -= w.css(e, 'border' + ne[a] + 'Width', !0, r)))
      ...
      style: function (e, t, n, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var r,
            ...
            l = Ve.test(t),
            u = e.style;
          if ((l || (t = ze(s)), (a = w.cssHooks[t] || w.cssHooks[s]), void 0 === n))
    ...
    function st() {
      nt &&
        (!1 === m.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(st) : e.setTimeout(st, w.fx.interval),
        w.fx.tick());
    }
    function lt() {
      return (
    ...
    function ft(e, t, n) {
      var i,
        ...
        l = function () {
          ...
          for (
            ...
            u.tweens[o].run(i);
          return (
            s.notifyWith(e, [u, i, n]), i < 1 && a ? n : (a || s.notifyWith(e, [u, 1, 0]), s.resolveWith(e, [u]), !1)
          );
        },
        u = s.promise({
          elem: e,
      ...
      for (
        ...
        if ((i = ft.prefilters[o].call(u, e, c, u.opts)))
          return p(i.stop) && (w._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)), i;
      return (
        w.map(c, ct, u),
          ...
          if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(h))
            for (i in (f &&
              ...
              'none' === (c = w.css(e, 'display')) &&
                (u ? (c = u) : (ue([e], !0), (u = e.style.display || u), (c = w.css(e, 'display')), ue([e]))),
        ...
        attr: function (e, t, n) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
            return void 0 === e.getAttribute
              ? w.prop(e, t, n)
              : ((1 === o && w.isXMLDoc(e)) ||
                  (r = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? dt : void 0)),
                void 0 !== n
                  ? null === n
        ...
        toggleClass: function (e, t) {
          ...
          return 'boolean' == typeof t && i
            ...
            : this.each(function () {
                var t, r, o, a;
                if (i)
                  for (r = 0, o = w(this), a = yt(e); (t = a[r++]); ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                else
                  (void 0 !== e && 'boolean' !== n) ||
    ...
    w.extend(w.event, {
      trigger: function (t, n, i, r) {
        ...
        if (
          ...
          if (!r && !d.noBubble && !g(i)) {
            for (bt.test((l = d.delegateType || y) + y) || (a = a.parentNode); a; a = a.parentNode) v.push(a), (s = a);
    ...
    (Ft.href = Tt.href),
      w.extend({
        ...
        ajax: function (t, n) {
          ...
          if (
            (v.promise(x),
            (h.url = ((t || h.url || Tt.href) + '').replace(qt, Tt.protocol + '//')),
          ...
          h.hasContent
            ...
            : ((d = h.url.slice(r.length)),
              h.data &&
                ...
                ((r += (xt.test(r) ? '&' : '?') + h.data), delete h.data),
              !1 === h.cache && ((r = r.replace(It, '$1')), (d = (xt.test(r) ? '&' : '?') + '_=' + Et.guid++ + d)),
              (h.url = r + d)),
          h.ifModified &&
            (w.lastModified[r] && x.setRequestHeader('If-Modified-Since', w.lastModified[r]),
          ...
          if (((E = 'abort'), y.add(h.complete), x.done(h.success), x.fail(h.error), (i = Bt(Rt, h, n, x)))) {
            if (((x.readyState = 1), c && g.trigger('ajaxSend', [x, h]), u)) return x;
            h.async &&
              0 < h.timeout &&
          ...
          function C(t, n, a, l) {
            ...
            u ||
              ...
              f
                ? (h.ifModified &&
                    ((T = x.getResponseHeader('Last-Modified')) && (w.lastModified[r] = T),
                    (T = x.getResponseHeader('etag')) && (w.etag[r] = T)),
                  204 === t || 'HEAD' === h.type
                    ? (E = 'nocontent')
                    : 304 === t
                    ? (E = 'notmodified')
                    : ((E = b.state), (d = b.data), (f = !(m = b.error))))
              ...
              x.statusCode(_),
              (_ = void 0),
              c && g.trigger(f ? 'ajaxSuccess' : 'ajaxError', [x, h, f ? d : m]),
              y.fireWith(p, [x, E]),
              c && (g.trigger('ajaxComplete', [x, h]), --w.active || w.event.trigger('ajaxStop')));
          }
          return x;
        },
    ...
    w.ajaxSetup({
        ...
        if (s || 'jsonp' === t.dataTypes[0])
          return (
            ...
            s
              ...
              : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? '&' : '?') + t.jsonp + '=' + r),
      ...
      (h.createHTMLDocument =
        ((($t = m.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>'),
      ...
      (w.parseHTML = function (e, t, n) {
        return 'string' != typeof e
          ...
          : ('boolean' == typeof t && ((n = t), (t = !1)),
            ...
            (r = A.exec(e))
              ? [t.createElement(r[1])]
              : ((r = _e([e], t, o)), o && o.length && w(o).remove(), w.merge([], r.childNodes)));
        var i, r, o;
      }),
